...
#include "PRSMultiPanelModeChanger.h"
...
APRSMultiPanelModeChanger::APRSMultiPanelModeChanger()
{
...
void APRSMultiPanelModeChanger::BeginPlay()
{
	Super::BeginPlay();

	CenterBoxComp->OnComponentBeginOverlap.AddDynamic(this, &APRSMultiPanelModeChanger::CenterBoxCompOnComponentBeginOverlap);
	CenterBoxComp->OnComponentEndOverlap.AddDynamic(this, &APRSMultiPanelModeChanger::CenterBoxCompOnComponentEndOverlap);
	FrontBoxComp->OnComponentEndOverlap.AddDynamic(this, &APRSMultiPanelModeChanger::BoxCompOnComponentEndOverlap);
	BackBoxComp->OnComponentEndOverlap.AddDynamic(this, &APRSMultiPanelModeChanger::BoxCompOnComponentEndOverlap);
	RightBoxComp->OnComponentEndOverlap.AddDynamic(this, &APRSMultiPanelModeChanger::BoxCompOnComponentEndOverlap);
...
void APRSMultiPanelModeChanger::CenterBoxCompOnComponentEndOverlap(UPrimitiveComponent* OverlappedComponent, AActor* OtherActor,
...
void APRSMultiPanelModeChanger::BoxCompOnComponentEndOverlap(UPrimitiveComponent* OverlappedComponent, AActor* OtherActor,
	UPrimitiveComponent* OtherComp, int32 OtherBodyIndex)
{
...
void APRSMultiPanelModeChanger::InternalBoxComponentOnComponentEndOverlap(const UBoxComponent* OverlappedBoxComponent, APRSCharacter* PRSCharacter)
{
	// Get Box Direction
...
void APRSMultiPanelModeChanger::Tick(float DeltaTime)
{
	Super::Tick(DeltaTime);

}

void APRSMultiPanelModeChanger::OnConstruction(const FTransform& Transform)
{
